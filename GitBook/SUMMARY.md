...
* [Hermihugbúnaður](simulation_overview/simulation_software.md)
...
* [Sýnidæmi: Hermun á bankabiðraðakerfi](discrete_event_simulation/bank_queue_simulation.md)
...
* [Hugtakalíkan](real_to_model/conceptual_models.md)
* [Meginreglur líkanagerðar](real_to_model/modeling_principles.md)
...
* [Breytileiki í hermilíkönunum](results_analysis/about_distribution_selection.md)
...
## Prófanir hermilíkana
* [Sannprófun og trúverðugleiki](model_testing/model_validation.md)
* [Staðfesting á hermihugbúnaði](model_testing/software_verification.md)

## Eindalíkön
* [Uppbygging eindalíkana](agent_models/agent_based_models.md)
* [Sýnidæmi um eindalíkön](agent_models/agent_model_examples.md)

## Kvik kerfislíkön
* [Kerfishugsun og kvik hegðun](system_dynamics/system_dynamics.md)
* [Sýnidæmi um kvik kerfislíkön](system_dynamics/system_dynamics_examples.md)
